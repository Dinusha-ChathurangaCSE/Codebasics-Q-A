...
![image](https://github.com/user-attachments/assets/d01335e3-e8af-4be0-959b-ed792aa06ab0)
...
```bash
  git clone https://github.com/Dinusha-ChathurangaCSE/Codebasics-Q-A.git
```
2.Navigate to the project directory:

```bash
  cd Q&A bot for codebasics
```
